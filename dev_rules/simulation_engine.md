...
- `murder` records structured killer/victim/witness/motive/place/genome context and marks victims dead before same-year government succession runs. Murder event-memory records default to `violent_crime_record` with `rumored` visibility.
