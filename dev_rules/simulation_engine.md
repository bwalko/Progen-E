...
- Reusable scoring primitives live in `library.event_scoring`: signed genome basis functions, weighted propensity specs, role/pressure/opportunity context, composite-name weights, and candidate threshold/weight helpers. Keep future event-family scoring there rather than adding another ad hoc trait formula inside a generator.
