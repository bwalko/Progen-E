...
- `library/simulation_incidents.py`
  - Rare detailed personal incidents. Current slices generate bounded genome-driven `murder`, `property_crime`, `affair_scandal`, `public_virtue`, and `knowledge_culture` events from per-settlement adult samples, record actor/target/relationship/witness/motive/place/genome context, mark murder victims dead, and rely on event-memory records for public/rumored/lost/rediscovered history. Property crimes, scandals, public virtues, and knowledge/culture breakthroughs are non-lethal and do not mutate household/economy/relationship/reputation/knowledge-state balances yet.
