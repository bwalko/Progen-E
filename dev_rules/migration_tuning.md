...
4. If you need move-level detail, query `save.sqlite` `simulation_events` for `event_type = 'settlement_moved'` and JSON fields `cross_region`, `move_reason` (`resource_pressure_migration`), `from_region_id`, `to_region_id`.
