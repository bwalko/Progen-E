...
class GradioDataBrowserEventTests(unittest.TestCase):
    ...
    def test_person_sheet_and_share_show_composite_trait_scores(self) -> None:
        ...
        self.assertIn('<details class="composite-score-detail">', sheet)
        self.assertIn("<summary>Details</summary>", sheet)
        self.assertIn("Final normalized score:</strong> 1.12", sheet)
        self.assertIn("physical (excess): raw value unavailable; weight 1.000", sheet)
    ...
    def test_person_sheet_falls_back_to_computed_composite_scores(self) -> None:
        ...
        self.assertIn("physical (excess): raw value 80.000", sheet)
        self.assertIn("curved 1.000 x weight 1.000 = 1.000", sheet)
        self.assertIn("Normalization/blend:", sheet)
        self.assertIn("Special modifier:</strong> gender matches male", sheet)
        self.assertIn("Special modifier total:</strong> +0.230 x 1.000 = +0.230", sheet)
        self.assertIn("Final floor/clamp:</strong> raw final 1.230", sheet)
