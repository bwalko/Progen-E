...
def _hybrid_calibration_fields(
    ...
    *,
    ...
    return {
        ...
        "ordinary_murder_events": h.ordinary_murder_events,
        "feud_revenge_murder_events": h.feud_revenge_murder_events,
        "robbery_property_murder_events": h.robbery_property_murder_events,
        "outlaw_raid_killing_events": h.outlaw_raid_killing_events,
        "war_political_legal_killing_events": h.war_political_legal_killing_events,
        "spree_panic_killing_events": h.spree_panic_killing_events,
        "predatory_murder_events": h.predatory_murder_events,
        "serial_predatory_murder_events": h.serial_predatory_murder_events,
...
def _write_rows(path: Path, rows: list[dict[str, object]]) -> None:
    ...
    headers = [
        ...
        "murder_rate_population_basis",
        "murder_events",
        "ordinary_murder_events",
        "feud_revenge_murder_events",
        "robbery_property_murder_events",
        "outlaw_raid_killing_events",
        "war_political_legal_killing_events",
        "spree_panic_killing_events",
        "predatory_murder_events",
        "serial_predatory_murder_events",
